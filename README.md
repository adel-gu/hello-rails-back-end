...
This repo is a simple Rails api project with the an end point that generates random greeting messages.
...
```sh
  cd my-folder
  git clone git@github.com:adel-gu/hello-rails-back-end.git
```
